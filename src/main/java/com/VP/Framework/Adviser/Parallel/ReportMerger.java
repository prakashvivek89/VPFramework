package com.VP.Framework.Adviser.Parallel;
...
public class ReportMerger  {
    ...
    private void mergeResponse(File reportDirectory, String format, String reportFileName) throws IOException {
        System.out.println("In ReportMerger--->Report directory: " + reportDirectory + "  File format: " + format + "  Report fileName: " + reportFileName);
            ...
            if (report.getName().equals(reportFileName)) {
                ...
                if (mergedReport == null) {
                    if ("json".equals(format)) {
                    	System.out.println("File json in the folder:  "+report.getAbsoluteFile().toString());
                        FileUtils.copyFileToDirectory(report.getAbsoluteFile(), reportDirectory);
                        mergedReport = new File(reportDirectory, reportFileName);
                        System.out.println("merged file : "+mergedReport.toString());
                    } else if ("js".equals(format)) {
                    	System.out.println("File json in the folder:  "+report.getParentFile().toString());
    ...
    private void mergeJsFiles(File target, File source) throws IOException {
        ...
        System.out.println("targetedJS report : "+targetReport);
        System.out.println("sourceJS report : "+sourceReport);
    ...
    private void mergeJsonFiles(File jsonTarget, File jsonSource) throws IOException {
        ...
        System.out.println("targetedJSON report : "+targetReport);
        System.out.println("sourceJSON report : "+sourceReport);
